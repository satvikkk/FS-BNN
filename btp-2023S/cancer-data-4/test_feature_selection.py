...
curr_dir = "UpdatedCode/cancer-data-4"
code = "Feature_selection"
#------------------------------------------------------------------------------------------------------
# Create a simple dataset
dm_lgg = pd.read_csv(f"{curr_dir}/dm_lgg.csv")
df_lgg = pd.read_csv(f"{curr_dir}/df_lgg.csv")

data = dm_lgg.T.drop("Unnamed: 0")
data = data.astype('float32')
df_lgg = df_lgg.iloc[:data.shape[0]]
Y = df_lgg["Supervised.DNA.Methylation.Cluster"].values.astype(str)
