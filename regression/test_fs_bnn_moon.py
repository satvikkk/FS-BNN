...
from sparse_bnn import FeatureSelectionBNN
...
for k in range(rep):
    ...
    # create sparse BNN
    net = FeatureSelectionBNN(data_dim=data_dim, device=device).to(device)
    ...
    df.to_csv("moon_fs_sparse_one1w", index = False)
