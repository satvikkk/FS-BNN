...
curr_dir = "UpdatedCode/cancer-data-3"
code = "Feature_selection"
#------------------------------------------------------------------------------------------------------
# Create a simple dataset
dm_thca = pd.read_csv(f"{curr_dir}/dm_thca.csv")
df_thca = pd.read_csv(f"{curr_dir}/df_thca.csv")

data = dm_thca.T.drop("Unnamed: 0")
data = data.astype('float32')
df_thca = df_thca.iloc[:data.shape[0]]


Y = df_thca["mRNA_Cluster_number"].values.astype(str)
