...
import time
import sys
sys.path.insert(0,'/Users/lokpati/Documents/GitHub/sbnn/btp-2023S/')
...
curr_dir = "/Users/lokpati/Documents/GitHub/sbnn/btp-2023S/cancer-data-2"
code = "Feature_selection"
#------------------------------------------------------------------------------------------------------
# Create a simple dataset
dm_prad = pd.read_csv(f"{curr_dir}/dm_prad.csv")
df_prad = pd.read_csv(f"{curr_dir}/df_prad.csv")

data = dm_prad.T.drop("Unnamed: 0")
data = data.astype('float32')

Y = df_prad["subtype_Reviewed_Gleason_sum"].values.astype(str)
X = data.drop(data.index[(Y!='1-ERG') & (Y!='5-SPOP') & (Y!='8-other')])
Y = Y[(Y=='1-ERG') | (Y=='5-SPOP') | (Y=='8-other')]
